...
export default function Rewards() {
  ...
  const [coupon, setCoupon] = useState<{ name: string; code: string } | null>(
  ...
  const redeem = async (r: (typeof rewards)[number]) => {
    ...
    if (redeemError) {
      ...
      toast.error(redeemError.message || "Redemption failed");
    ...
    if (profileError) {
      ...
      console.error("Coin update error:", profileError);
    ...
    <AppShell>
      ...
      <header className="bg-primary text-primary-foreground rounded-b-3xl px-5 pt-12 pb-6 shadow-card">
        ...
        <div className="mt-4 rounded-2xl bg-white/15 backdrop-blur p-4 flex items-center justify-between">
          ...
          <span className="rounded-full bg-gold text-gold-foreground text-[10px] font-bold uppercase px-2.5 py-1">
      ...
      {cat === "experiences" ? (
        ...
        <section className="px-5 mt-4 space-y-3 pb-28">
          ...
          <div className="rounded-2xl bg-gradient-to-br from-primary/10 via-gold/10 to-deep-blue/10 border border-border p-3 flex items-start gap-3">
            ...
            <p className="text-xs text-foreground/80 leading-relaxed">
              ...
              <span className="font-bold text-foreground">Eco-Experiences</span>{" "}

              turn your recycling into real-life adventures — only unlockable

              here. Limited slots every week.
                    ...
                    <div className="mt-2 flex items-center justify-between gap-2">
                      ...
                      >
                        ...
                        {affordable
                          ...
                          : `Need ${(r.cost - coins).toLocaleString()}`}
        ...
        <section className="px-5 mt-4 grid grid-cols-2 gap-3 pb-28">
          ...
          {list.map((r) => {
            ...
            return (
              ...
              <div
                ...
                className="rounded-2xl bg-card border border-border p-3 shadow-card flex flex-col"
              ...
              >
                ...
                <p className="mt-2.5 text-sm font-bold leading-tight">
        ...
        <DialogContent className="max-w-[380px] rounded-2xl">
          ...
          <div className="grid grid-cols-2 gap-2 mt-2">
            ...
            <Button
              ...
              onClick={() => confirm && redeem(confirm)}
      ...
      <Dialog open={!!coupon} onOpenChange={(o) => !o && setCoupon(null)}>
        ...
        <DialogContent className="max-w-[380px] rounded-2xl">
          ...
          <p className="text-center text-xs text-muted-foreground">
            ...
            Show this QR to canteen / partner staff
